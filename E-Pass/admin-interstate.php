                ...
                <div class="row">
                    ...
                    <div class="col-xl-10 col-lg-9 col-md-8 ml-auto bg-dark fixed-top py-2 top-navbar">
                        <div class="row align-items-center">
                            <div class="col-md-4">
                                <h4 class="text-light text-uppercase mb-0">Interstate</h4>
                            </div>
            ...
            <?php
                                    ...
                                    while($row = mysqli_fetch_assoc($application_connection)) {
                                        ...
                                        echo"<tr>";
                                            ...
                                            echo"<td>{$reason}</td>";
                                            echo"<td>{$status}</td>";
                                            echo"<td><a href='admin-interstate.php?accept={$aadhar_number}'>Accept</a></td>";
                                            echo"<td><a href='admin-interstate.php?reject={$aadhar_number}'>Reject</a></td>";
                                        echo"</tr>";
                                    }
                                ?>
                            </tbody>
                        ...
                        <?php
                            if(isset($_GET['accept'])) {
                                ...
                                $query = "update interstate set status = 'Accepted' where aadhar_number = {$aadhar_number}";
                                $accept_query = mysqli_query($connection,$query);
                            }
                            if(isset($_GET['reject'])) {
                                $aadhar_number = $_GET['reject'];
                                $query = "update interstate set status = 'Rejected' where aadhar_number = {$aadhar_number}";
