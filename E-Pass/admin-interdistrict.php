...
<body>
                ...
                <div class="row">
                    ...
                    <div class="col-xl-10 col-lg-9 col-md-8 ml-auto bg-dark fixed-top py-2 top-navbar">
                        <div class="row align-items-center">
                            <div class="col-md-4">
                                <h4 class="text-light text-uppercase mb-0">Interdistrict</h4>
                            </div>
    ...
    <section>
        <div class="container-fluid">
            ...
            <?php
                                    $query = "select * from interdistrict";
                                    $application_connection = mysqli_query($connection,$query);
                                    while($row = mysqli_fetch_assoc($application_connection)) {
                                        ...
                                        echo"<tr>";
                                            ...
                                            echo"<td>{$reason}</td>";
                                            echo"<td>{$status}</td>";
                                            echo"<td><a href='admin-interdistrict.php?accept={$aadhar_number}'>Accept</a></td>";
                                            echo"<td><a href='admin-interdistrict.php?reject={$aadhar_number}'>Reject</a></td>";
                                        echo"</tr>";
                                    }   
                                ?>
                            </tbody>
                        ...
                        <?php
                            if(isset($_GET['accept'])) {
                                $aadhar_number = $_GET['accept'];
                                $query = "update interdistrict set status = 'Accepted' where aadhar_number = {$aadhar_number}";
                                $accept_query = mysqli_query($connection,$query);
                            }
                            if(isset($_GET['reject'])) {
                                $aadhar_number = $_GET['reject'];
                                $query = "update interdistrict set status = 'Rejected' where aadhar_number = {$aadhar_number}";
