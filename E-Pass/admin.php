...
<?php
    $query = "call p1(@a)";
    $p1_connection = mysqli_query($connection,$query);
?>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-danger" data-dismiss="modal" onClick="location.href='login.php'" >Logout</button>
                </div>
            </div>
        </div>
    </div>
                                ...
                                <div class="card-body">
                                    <div class="d-flex justify-content-between">
                                        ...
                                        <div class="text-right text-secondary">
                                            <h5>INTERSTATE</h5>
                                            <h3><?php $query = "CALL `p1`(@p0);"; 
                                                if($p2_connection = mysqli_query($connection,$query)){
                                                    $query="SELECT @p0 AS `a`;";
                                                if($p1_connection = mysqli_query($connection,$query)) {
                                                  while($row = mysqli_fetch_row($p1_connection)) {
                                                      print_r($row[0]);
                                                  }
                                                }
                                                    }
                            ...
                            <div class="card card-common">
                                <div class="card-body">
                                    <div class="d-flex justify-content-between">
                                        ...
                                        <div class="text-right text-secondary">
                                            <h5>INTERDISTRICT</h5>
                                            <h3><?php $query = "CALL `p2`(@p0);"; 
                                                if($p2_connection = mysqli_query($connection,$query)){
                                                    $query="SELECT @p0 AS `b`;";
                                                if($p1_connection = mysqli_query($connection,$query)) {
                                                  while($row = mysqli_fetch_row($p1_connection)) {
                                                      print_r($row[0]);
                                                  }
                            ...
                            <div class="card card-common">
                                <div class="card-body">
                                    <div class="d-flex justify-content-between">
                                        ...
                                        <div class="text-right text-secondary">
                                            <h5>CONTACT US</h5>
                                            <h3><?php $query = "CALL `p3`(@p0);"; 
                                                if($p2_connection = mysqli_query($connection,$query)){
                                                    $query="SELECT @p0 AS `c`;";
                                                if($p1_connection = mysqli_query($connection,$query)) {
                                                  while($row = mysqli_fetch_row($p1_connection)) {
                                                      print_r($row[0]);
                                                  }
